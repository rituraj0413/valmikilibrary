...
urlpatterns = [
    ...
    path('student-detail/messages/<int:student_id>/', views.admin_student_message, name='admin_student_message'),
    ...
    path('student-portal/messages/', views.student_portal_message, name='student_portal_message'),
    path('student-portal/payments/create-order/', views.student_portal_create_online_payment, name='student_portal_create_online_payment'),
    path('student-portal/payments/verify/', views.student_portal_verify_online_payment, name='student_portal_verify_online_payment'),
    path('student-portal/mentorship/', views.student_portal_mentorship, name='student_portal_mentorship'),
    path('mentorship/sessions/<int:session_id>/room/', views.mentorship_session_room, name='mentorship_session_room'),
